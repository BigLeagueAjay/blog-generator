...
# Navigate to the blog-generator directory
cd /home/ajay/blog-generator
...
- Publish directly to WordPress" > README.md
...
# Commit the files
git commit -m "Initial commit: Blog generator interface"
...
git remote add origin https://github.com/BigLeagueAjay/blog-generator.git
git branch -M main
git push -u origin main

After pushing, enable GitHub Pages:
1. Go to https://github.com/BigLeagueAjay/blog-generator/settings/pages
2. Under 'Source', select 'main' branch
3. Click 'Save'

Your site will be available at: https://bigleagueajay.github.io/blog-generator/
"

# Make the script executable
chmod +x /home/ajay/blog-generator/index.html
